...
--
-- НЕ Е ПЪЛЕН ОТ 20.09.2026: продължението е в loading-lists-missing-schema.sql
-- (колоните missing / missing_by / missing_at и статусът 'partial'). Двата се
-- четат ЗАЕДНО — този тук описва схемата към 03.09.2026 и НЕ се обновява
-- задним числом, за да не се разминат датата на сверката и съдържанието.
--
-- ЗА КАКВО СЛУЖИ
