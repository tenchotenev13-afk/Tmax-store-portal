-- ═══ ПОКРИТА ОТ МИГРАЦИЯ ═══════════════════════════════════════════════
-- Записът за схемата е
--   supabase/migrations/20260819123733_stock_differences_responsibility_fields.sql
-- Този файл е историческа бележка: не го пускай и не го приемай за
-- източник на истината. Сверено на 19.08.2026.
-- Rollback-ът вече живее в отделен _down.sql до миграцията, както изисква
-- конвенцията — закоментираният по-долу остава само като исторически текст.
-- ══════════════════════════════════════════════════════════════════════
