...
function ctStyleTag(){
  return '<style id="ct-style">'+
    ...
    '.ct-c-name{font-weight:600;color:#0f172a;}'+
...
function renderContactsFilters(){
  ...
  if(contactsTab==='contact'){
    ...
    box.innerHTML='<select id="ct-store-filter" onchange="setContactsStore(this.value)" style="border:1px solid #e2e8f0;border-radius:8px;padding:7px 12px;font-size:13px;font-family:inherit;background:#fff;">'+
  ...
  cats.forEach(function(cat){
    ...
    m.forEach(function(c){
      ...
      h+='<div '+ctRowAttrs(c)+'>'+
        ...
        '<div class="ct-c-name">'+esc(c.name||'')+'</div>'+
