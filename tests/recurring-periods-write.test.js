/* Постоянните задачи по седмици (recurring_task_periods) — ПИСАНЕ.
   ...
   В стар бюлетин трите са скрити, със сив текст. Бъдещ бюлетин (Добави /
   Активирай там, Спри не) — в recurring-future-week.test.js.
...
(async function () {
  ...
  section('7. Стар бюлетин — без Спри/Активирай/Добави, със сивия текст');
  for (const [bulId, label] of [['b-prev', 'минала']]) {
