...
/* Снимката е обновена на 13.09.2026 (5388 -> 5421): формата за нова бланка
   получи празен <div id="diff-no-doc-wrap"></div> под полето "Документ №" -
   точно 33 знака и нищо друго, проверено машинно срещу модала от 4fb0753.
   Контейнерът е празен при посока по подразбиране (междускладов); отметката
   "без документ" се рисува в него само при посока доставчик. */
/* Обновена отново на 13.09.2026 (5421 -> 5470): три подсказки и нищо друго,
   проверено машинно срещу модала от 178334d -
     diff-docnum   "напр. 4600179694" -> "вх. доставка 180486328 или документ 4600179694"  (+30)
     di-qty        "По вх. доставка"  -> "Количество по документ (бр.)"                  (+13)
