/* transport.js — Транспортни заявки + бланка за шофьора
   Редактирай САМО тук когато правиш промени по транспорта. */
...
function renderTransport(){
  ...
  if(!list.length){body.innerHTML='<tr><td colspan="10" style="text-align:center;padding:30px;color:#94a3b8;">Няма транспортни заявки.</td></tr>';return;}
...
function openTransportModal(){
  ['o-bon','o-name','o-phone','o-addr','o-product','o-color','o-agent','o-notes'].forEach(function(id){var el=document.getElementById(id);if(el)el.value='';});
...
function renderTransportPrint(o){
  ...
  var half=function(){
    return '<div style="padding:20px 24px 16px;font-family:Arial,sans-serif;font-size:13px;color:#1a1a1a;">'+
      '<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:14px;">'+
        '<div><div style="font-size:13px;font-weight:700;">'+esc(o.store_name||'')+'</div>'+
        '<div style="font-size:11px;color:#555;margin-top:2px;">'+esc(o.address||'')+'</div></div>'+
      ...
      '</div>'+
      '<div style="margin-bottom:5px;"><b>Изискване за транспорт от дата:</b> '+esc(fmtDate(o.date||''))+'</div>'+
      '<div style="margin-bottom:4px;"><b>Касов бон:</b> '+esc(o.bon||'—')+'</div>'+
      '<div style="margin-bottom:4px;"><b>Клиент:</b> '+esc(o.customer_name||'')+'</div>'+
      '<div style="margin-bottom:4px;"><b>Адрес:</b> '+esc(o.address||'')+'</div>'+
      '<div style="margin-bottom:4px;"><b>Телефон за връзка:</b> '+esc(o.phone||'')+'</div>'+
      '<div style="margin-bottom:12px;"><b>Продукти:</b> '+esc(o.product||'')+(o.color?' - '+esc(o.color):'')+' ('+esc(String(o.qty||1))+' бр.)</div>'+
      '<div style="display:flex;gap:32px;margin-bottom:18px;">'+
        '<div><b>Дата за доставка:</b> '+fmtDate(o.delivery)+'</div>'+
        '<div><b>Час за доставка:</b> '+esc(o.hour||'—')+'</div>'+
      '</div>'+
      '<div style="border-top:1px dotted #999;padding-top:10px;">'+
        '<div style="margin-bottom:6px;">............................................................................................................</div>'+
        '<div style="margin-bottom:14px;"><b>Получил:</b> ..................................................................................................</div>'+
        '<div style="font-weight:600;">Получих стоката без забележка!</div>'+
      '</div></div>';
  };
  var dot='<div style="text-align:center;color:#94a3b8;font-size:11px;letter-spacing:.15em;border-top:2px dashed #ccc;padding-top:4px;">— — — — — — — — — — ОТКЪСВАТЕ ТУК — — — — — — — — — —</div>';
  wrap.innerHTML='<div style="max-width:620px;margin:0 auto;padding:20px 16px 60px;">'+
    ...
    '<div style="font-size:12px;color:#64748b;background:#f8fafc;border-radius:8px;padding:9px 13px;margin-bottom:14px;" class="no-print">'+
      '📄 Листът се скъсва по пунктираната линия — едно копие за шофьора, едно за магазина.</div>'+
    '<div class="print-blank" style="background:#fff;border:1px solid #ccc;border-radius:8px;overflow:hidden;">'+half()+dot+half()+'</div></div>';
}
